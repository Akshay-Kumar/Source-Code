...
{
    public delegate void PopulateSourceCode(string code);
    public partial class PowerfulSample : Form
    {
        //delegate for populating source code
        public PopulateSourceCode setCode;
        ...
        public PowerfulSample(string code)
        {
            this.setCode = new PopulateSourceCode(GlobalPageTracker.sourceCodeObj.FillRichTextBox);
            InitializeComponent();
            fctb.Clear();
            fctb.Text = code;
        }
