...
namespace SplashScreen
{
	...
	public partial class SplashScreen : Form
	{
        ...
        private static string appMiniLabel;
        private static string appBigLabel;
		// Threading
        ...
        /// <summary>
        ///A static method to update task label 
        /// </summary>
        /// <param name="text"></param>
        public static void UpdateTaskLabel(string text)
        {
            taskLabel = text;
        }
        /// <summary>
        ///A static method to update appMini label 
        /// </summary>
        /// <param name="text"></param>
        public static void UpdateAppMiniLabel(string text)
        {
            appMiniLabel = text;
        }
        /// <summary>
        ///A static method to update bigApp label 
        /// </summary>
        /// <param name="text"></param>
        public static void UpdateBigAppLabel(string text)
        {
            appBigLabel = text;
        }
		...
		private void UpdateTimer_Tick(object sender, System.EventArgs e)
		{
            ...
            tasks.Text = taskLabel;
            appMini.Text = appMiniLabel;
            bigApp.Text = appBigLabel;
			// Calculate opacity
