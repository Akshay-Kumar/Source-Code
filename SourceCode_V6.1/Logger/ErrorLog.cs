...
namespace Logger
{
	...
	public class ErrorLog
    {
        ...
        static PopupNotifier notificationMessage = null;
        static StringBuilder sb = null;
        static ProcessMonitor monitor = null;
        #endregion
        /// <summary>
        ...
        private static bool CustomErrorRoutine(Exception objException)
        {
            ...
            if (true != WriteErrorLog(ErrorLog.LogFilePath = strPathName, objException))
            {
                bReturn = false;
            }
            return bReturn;
        ...
        {
            bool bReturn = false;
            notificationMessage = new PopupNotifier();
            ...
            try
            {
                ...
                sw.WriteLine("---------------------------------------------------------------------------------------------------");
                /****************************************For Notification Popup Message*********************************************/
                sb.Append(ERROR_LABEL.SOURCE + "     \t  :" + objException.Source.ToString().Trim());
                sb.Append("\n");
                sb.Append(ERROR_LABEL.METHOD + "     \t  :" + objException.TargetSite.Name.ToString().Trim());
                sb.Append("\n");
                sb.Append(ERROR_LABEL.DATE + "       \t  :" + string.Format("{0:MM/dd/yyyy}", DateTime.Now));
                sb.Append("\n");
                sb.Append(ERROR_LABEL.TIME + "       \t  :" + string.Format("{0:hh-.mm-ss-ffff tt}", DateTime.Now));
                sb.Append("\n");
                sb.Append(ERROR_LABEL.ERROR + "      \t  :" + objException.Message.ToString().Trim());
                ShowPopupMessage("Exception Notification", sb.ToString().Trim());
                /******************************************************************************************************************/
                sw.Flush();
                sw.Close();
                bReturn = true;
        ...
        /// <summary>
        /// public void ShowSuccessMessage(string title,string content,NotificationType type)
        /// </summary>
        /// <param name="title"></param>
        /// <param name="content"></param>
        /// <param name="type"></param>
        public static void ShowPopupMessage(string title, string content)
        {
            Bitmap image = Properties.Resources.notification_error_1_;
            notificationMessage.TitleText = title;
            notificationMessage.ContentText = content;
            notificationMessage.Image = image;
            notificationMessage.Popup();
    ...
    {
        private static string defaultLogFile = "Logger.log";
